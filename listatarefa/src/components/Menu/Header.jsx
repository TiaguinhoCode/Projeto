                ...
                <div className="flex flex-wrap items-center justify-between max-w-screen-xl mx-auto p-4">
                    ...
                    <div className="flex items-center md:order-2">
                        <ul className="button_logar">
                            ...
                            <li>
                                <a href="#" className="button_registra text-white  hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 md:px-5 md:py-2.5 mr-1 md:mr-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">
                                    Sign up
                                </a>
                            </li>
                        </ul>
                                ...
                                <div className="nav_menu p-4">
                                    <ul className="space-y-4">
                                        ...
                                        <li className="registra_entra">
                                            ...
                                            <a href="#" className="button_registra text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 md:px-5 md:py-2.5 mr-1 md:mr-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">
                                                Sign up
                                            </a>
                                        </li>
                                    </ul>
